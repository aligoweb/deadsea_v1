<?php
// HTTP
define('HTTP_SERVER', 'http://merseadeadsea.ru/admin/');
define('HTTP_CATALOG', 'http://merseadeadsea.ru/');

// HTTPS
define('HTTPS_SERVER', 'http://merseadeadsea/admin/');
define('HTTPS_CATALOG', 'http://merseadeadsea.ru/');
